...
<p class="lps-button-row"><button class="lps-button lps-button-primary" type="submit">${esc(t(copy.form.submit, locale))}</button><a class="lps-more" href="${en ? "/en/contact/" : "/contato/"}">${esc(t(copy.form.lost, locale))}</a></p>
</fieldset>
