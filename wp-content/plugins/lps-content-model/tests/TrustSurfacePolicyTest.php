...
final class TrustSurfacePolicyTest extends TestCase {
	...
	public function test_publish_gate_blocks_absent_contact_and_stale_or_unsourced_claims(): void {
		$opportunity = Policy::publish_errors(
			'lps_opportunity',
			array(
				'post_title' => 'Opportunity', 'post_excerpt' => 'Summary', 'post_content' => 'Body', '_lps_locale' => 'en',
				'_lps_opportunity_type' => 'scholarship', '_lps_eligibility' => 'Eligibility', '_lps_application_instructions' => 'Instructions',
				'_lps_opens_at' => '2026-09-01T12:00:00+00:00', '_lps_closes_at' => '2026-09-20T12:00:00+00:00',
			)
		);
		self::assertSame( 'lps_public_handoff_required', $opportunity['_lps_contact'] );

		$claim = TrustSurfacePolicy::claim_errors(
			array( '_lps_claim_verified' => true, '_lps_claim_source_url' => '', '_lps_claim_reviewed_at' => '2025-01-01' ),
