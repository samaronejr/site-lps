...
/** Rights-aware accessible media contract tests. */
final class MediaContractsTest extends \PHPUnit\Framework\TestCase {
	use MediaTestFixtures;

	/**
	 * Provides upload cases.
	 *
	...
	/**
	 * Verifies that upload allowlists enforce mime size and dimensions.
	 *
	 * @param string      $mime Upload MIME type.
	 * @param int         $bytes Upload byte count.
	 * @param int         $width Image width.
	 * @param int         $height Image height.
	 * @param string|null $error Expected rejection code, or null.
	 */
	...
	/**
	 * Verifies that attachment metadata is typed and complete.
	 */
	...
	/**
	 * Verifies that locked dynamic block contracts are complete.
	 */
	...
	/**
	 * Verifies that checksum duplicate is denied before public mutation.
	 */
	...
	/**
	 * Verifies that rights and privacy are hard publication gates.
	 */
	...
	/**
	 * Verifies that per use alt and decorative are exclusive and filename alt is denied.
	 */
	...
	/**
	 * Verifies that repeated asset requires distinct contextual localized alt.
	 */
	...
	/**
	 * Verifies that video requires label caption transcript and never autoplays.
	 */
	...
	/**
	 * Verifies that essential pdf requires contextual html equivalent.
	 */
