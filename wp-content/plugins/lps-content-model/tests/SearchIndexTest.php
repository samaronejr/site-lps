...
require_once __DIR__ . '/class-recordingsearchstorage.php';

/** Contract tests for the plugin-owned locale search index. */
final class SearchIndexTest extends \PHPUnit\Framework\TestCase {
	/**
	...
	public function test_private_metadata_never_reaches_an_index_row(): void {
		...
		$encoded = (string) wp_json_encode( $row, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE );
