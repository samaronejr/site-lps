...
trait MediaTestFixtures {
	...
	private static function valid_image_asset(): array {
		return array(
			'id'             => 41,
			'mime'           => 'image/jpeg',
			'url'            => '/uploads/experiment-2026.jpg',
			'filename'       => 'experiment-2026.jpg',
			'width'          => 2400,
			'height'         => 1600,
			'credit'         => 'LPS archive',
			'rights_holder'  => 'LPS',
	...
	private static function valid_video_asset(): array {
		return array(
			...
			'rights_holder'     => 'LPS',
			'license'           => 'authorized-use',
			'source_url'        => 'https://records.example/asset/52',
			'checksum'          => 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb',
			'rights_status'     => 'cleared',
			'privacy_status'    => 'reviewed',
			'caption_status'    => 'provided',
			'transcript_status' => 'provided',
		);
	}

	/**
	 * Provides valid pdf asset.
	 *
	 * @return array<string, int|string>
	 */
	private static function valid_pdf_asset(): array {
		return array(
			...
			'rights_holder'   => 'LPS',
			'license'         => 'authorized-use',
			'source_url'      => 'https://records.example/asset/63',
			'checksum'        => 'cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc',
			'rights_status'   => 'cleared',
			'privacy_status'  => 'reviewed',
			'document_status' => 'html-equivalent',
		);
	}

	/**
	 * Provides image usage.
	 *
	 * @param string $alt Contextual alternative text.
	 * @param bool   $decorative Whether the use is decorative.
	 * @param string $context Editorial use context.
	 * @param string $placement Page placement.
